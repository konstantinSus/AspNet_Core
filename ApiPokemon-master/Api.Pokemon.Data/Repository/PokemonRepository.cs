...
namespace Api.Pokemon.Data
{
    public class PokemonRepository : IPokemonRepository
    {
        ...
        public PokemonRepository(IOptions<MongoSettings> settings) => _context = new PokemonContext(settings);
        ...
        public async Task<List<PokemonDate>> GetAllCollection()
        {
            ...
            return await this._context.Pokemons.Find(filter).ToListAsync();
        }
